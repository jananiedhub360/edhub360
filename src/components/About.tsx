  ...
  return (
    <section id="about" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Roadmap */}
        <div>
          <h3 className="text-3xl font-bold text-[#00446E] mb-12 lg:mb-1 text-center">Our Strategic Direction</h3>
            ...
            <div className="relative max-w-7xl mx-auto overflow-x-auto">
              ...
              <div className="hidden lg:block relative min-h-[650px] py-8">
                ...
                >
                  {/* Main Road Path */}
                  <path
                    d="M 0 325 L 50 325 Q 175 225 300 325 Q 425 425 550 325 Q 675 225 800 325 Q 925 425 1050 325 Q 1175 225 1300 325 Q 1400 375 1450 325 L 1500 325"
                    stroke="#374151"
                    strokeWidth="45"
                    fill="none"
                ...
                <div className="absolute inset-0">
                  ...
                  {/* Q1-2026 - Above road */}
                    ...
                    {/* Q4-2026 - Below road */}
                    <div className="absolute" style={{ left: '935px', top: '375px' }}>
                      <div className="bg-white border-2 border-[#009C9F] rounded-xl p-4 w-60 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        <div className="flex items-center mb-2">
